        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="${basepath}/static/images/img_2.jpg" alt="Generic placeholder image" class="img-fluid">
            ...
            <div class="col-md-4 mb-4">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="${basepath}/static/images/img_3.jpg" alt="Generic placeholder image" class="img-fluid">
                        <div class="overlap-text">
                  <span>
                    Featured Room 
                    <span class="ion-ios-star"></span>
            ...
            <div class="col-md-4 mb-4">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="${basepath}/static/images/img_1.jpg" alt="Generic placeholder image" class="img-fluid">
                        <div class="overlap-text">
                  <span>
                    Featured Room 
                    <span class="ion-ios-star"></span>
